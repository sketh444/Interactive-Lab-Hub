...
if wf.getnchannels() != 1 or wf.getsampwidth() != 2 or wf.getcomptype() != "NONE":
    ...
    exit (1)
wf2 = wave.open(sys.argv[1], "rb")
#if wf2.getnchannels() != 1 or wf2.getsampwidth() != 2 or wf2.getcomptype() != "NON$ 
 #   print ("Audio file must be WAV format mono PCM.")
  #  exit (1)
             ...
             if rec.AcceptWaveform(data): 
                 ...
                 if len(s3) == 7:
                   ...
                   #  counter = counter + 1
                     ...
                     os.popen('sh /home/pi/Interactive-Lab-Hub/Lab3/no.sh')    
                     break
#        if counter == 2:
#             time.sleep(0.3)
 #            data2 = wf2.readframes(4000)
  #           if len(data2) == 0:
   #              break
    #         if rec2.AcceptWaveform(data2): 
     #            myResult2 = rec2.Result()
      #           print(myResult2)
       #          myList = myResult2.split("text" )
        #         s = myList[1]
         #        s2 = s.split(" : ")
          #       s3 = s2[1]
           #      print(s3)
            #     print(len(s3))
             #    if len(s3) == 7:
              #      os.popen('sh /home/pi/Interactive-Lab-Hub/Lab3/step2.sh') 
               #     time.sleep(20)
                #    break
                 #else:
